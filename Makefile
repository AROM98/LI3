...
CC=gcc
CFLAGS = -Wall -std=c11 -g -v -Ofast  -ansi `pkg-config  --libs glib-2.0` # -std=c11 -g -v -Ofast
LDFLAGS = -Wall -std=c11 -g -v -Ofast  -ansi `pkg-config  --cflags glib-2.0` # -std=c11 -g -v -Ofast
